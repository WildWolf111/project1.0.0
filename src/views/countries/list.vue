...
export default {
 ...
 console.log(this.setPage)
    ...
    setActiveCountries(countrys, index) {
      this.currentCountries = countrys;
      this.currentIndex = countrys ? index : -1;
    },
...
<div>
    <div class="col-lg-6">
         <div class="input-group">
                ...
                <button class="btn btn-outline-success" type="button" id="button-addon2" @click="getCountryByName" key="enter">search</button>
